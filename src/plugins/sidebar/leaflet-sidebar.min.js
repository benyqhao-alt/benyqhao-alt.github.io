(L.Control.Sidebar = L.Control.extend({
  ...
  onAdd: function (t) {
    ...
    for (
      (n =
        (n = this._container) ||
        (this._container || "string" == typeof this.options.container
          ? L.DomUtil.get(this.options.container)
          : this.options.container)) ||
        ((n = L.DomUtil.create("div", "leaflet-sidebar collapsed")),
        "string" == typeof this.options.container &&
          (n.id = this.options.container)),
        ...
        null === this._tabContainerBottom &&
          ((o = this._tabContainerTop.parentNode),
  ...
  onRemove: function (t) {
    ...
    return (
      (this._tabitems = []), (this._panes = []), (this._closeButtons = []), this
    );
  },
  addTo: function (t) {
    return (
  ...
  addPanel: function (t) {
    ...
    return (
      ...
      t.pane &&
        ...
        (e.id = t.id),
        this._panes.push(e),
        (o = e.querySelectorAll(".leaflet-sidebar-close")).length &&
          (this._closeButtons.push(o[o.length - 1]),
          this._closeClick(o[o.length - 1], "on"))),
      this._tabClick(i, "on"),
      this
    );
  },
  removePanel: function (t) {
    ...
    for (e = 0; e < this._panes.length; e++)
      if (this._panes[e].id === t) {
        for (
          n = (o = this._panes[e]).querySelectorAll(".leaflet-sidebar-close"),
            i = 0;
          i < n.length;
          i++
        )
    ...
    i.hasAttribute("href") &&
      ...
      ("on" === e
        ? L.DomEvent.on(
            ...
            t
          ).on(t.querySelector("a"), "click", this.onTabClick, t)
        : L.DomEvent.off(t.querySelector("a"), "click", this.onTabClick, t));
  },
